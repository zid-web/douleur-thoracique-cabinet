...
Sur Vercel, le dépôt se connecte tel quel : le répertoire racine du projet est la racine
du dépôt, et chaque push sur `main` déclenche un déploiement de production.
