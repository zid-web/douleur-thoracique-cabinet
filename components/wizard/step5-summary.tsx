...
<div class="page">
  ...
  <div class="footer">
    ...
    <p style="margin-top:3px">Document généré par <strong>Filière Angor Cardiomaine</strong> — Outil d'aide à la décision clinique · Usage strictement médical</p>
  </div>
</div>
</body>
</html>`
...
export function Step5Summary({ symptomData, rfclData, bayesianData, onReset }: Step5Props) {
  ...
  async function handleExportToOmniDoc() {
    try {
      ...
      const fileName = `FiliereAngor-DouleurThoracique-${dateStr}.html`
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl overflow-hidden border border-[#e2e8f0] bg-white">
        ...
        <div className="border-t border-[#f1f5f9] bg-[#f8fafc] px-5 py-3">
          ...
          <p className="text-[10px] text-[#94a3b8] mt-0.5">Document généré par Filière Angor Cardiomaine — Usage strictement médical</p>
        </div>
      </div>
